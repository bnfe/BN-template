...
const cdn = {
  // 开发环境
  dev: {
    css: ["//cdn-scp.banu.cn/npm/vant/2.12.37/index.min.css"],
    js: ["//cdn-scp.banu.cn/npm/eruda/2.4.1/eruda.min.js"],
  },
  // 生产环境
  build: {
    css: ["//cdn-scp.banu.cn/npm/vant/2.12.37/index.min.css"],
    js: [
      "//cdn-scp.banu.cn/npm/vue/2.6.14/vue.min.js",
      "//cdn-scp.banu.cn/npm/vuex/3.6.2/vuex.min.js",
      "//cdn-scp.banu.cn/npm/vue-router/3.5.3/vue-router.min.js",
      "//cdn-scp.banu.cn/npm/axios/0.24.0/axios.min.js",
      "//cdn-scp.banu.cn/npm/vant/2.12.37/vant.min.js",
    ],
  },
};
